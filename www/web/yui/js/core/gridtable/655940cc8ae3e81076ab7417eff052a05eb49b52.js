...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                ...
                                //"display": "envelope",
                                "ajaxUrl": "/admin/users/enabled?_token=60f3c31fe015671a214a4bef5f331493513fb888",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/disable?_token=60f3c31fe015671a214a4bef5f331493513fb888",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            archiverow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/archive?_token=60f3c31fe015671a214a4bef5f331493513fb888"
                            } );                            
