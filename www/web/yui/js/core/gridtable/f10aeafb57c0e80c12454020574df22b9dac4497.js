                    ...
                    {
                        $('#grid_category').dataTable().fnFilter( 
                            $("#global_filter").val(),
                            null, 
                    ...
                    function fnCreateFooterFilter() 
                    {
                        ...
                        $("table th").each( function ( i ) {
                                ...
                                if (column != undefined) {
                                	                                    if (values == undefined) {
                                        values = grid_categoryoTable.fnGetColumnData(column) 
                                    }
                                    if (type != "input") {
                                        var options = [];
                                        ...
                                        $('select', this).change( function () {
                                            ...
                                            grid_categoryoTable.fnFilter( values, column, true );
                                        });
                                            ...
                                            filter: function(e, matches) {
                                                ...
                                                if ( (ajaxsearch === true) || (ajaxsearch === 'true') ) {
                                                	if(keyword != $(e.target).data('keyword')) {
                                                    	grid_categoryoTable.fnFilter( keyword, column, true );
                                                	}
                                            	}
                                            }
                                        });                                        
                                        ...
                                        $(this).find('input').width('91%').attr('id', 'input_'+i).data('title', title).data('column', column).keyup( function () {
                                            ...
                                            search_timeout = setTimeout(function() {
                                              ...
                                              grid_categoryoTable.fnFilter( $this.value, column, true );
                                            }, 1000);
                                        } );
                                    }
...
/*
                        $("[id^='select_']").change( function () {
                            ...
                            grid_categoryoTable.fnFilter( values, $(this).data('column'), true );
                        });
                        $("[id^='select_']").multiselect({
                            ...
                            filter: function(e, matches) {
                                ...
                                var keyword = $('.ui-multiselect-filter:visible').find('input').val();
                                if(keyword != $(e.target).data('keyword')) {
                                    grid_categoryoTable.fnFilter( keyword, $(this).data('column'), true );
                                }
                            }
                        });
                        var foo_input = function() {
                            grid_categoryoTable.fnFilter( $(this).val(), $(this).data('column'), true );
                        };
...
*/
                    ...
                    $('#grid_category tbody tr').each(function(index) {
                        $(this).find("td.position").prependTo(this);
                    });
                    $('#grid_category thead tr').each(function(index) {
                    ...
                    $("tfooter input").keyup( function () {
                        grid_categoryoTable.fnFilter( this.value, grid_categoryoTable.oApi._fnVisibleToColumnIndex( 
                                grid_categoryoTable.fnSettings(), $("thead input").index(this) ) );
                    } );
					*/
                    
                                                                                                                                                        // Set up enabled row
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_category",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/category/enabled?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_category",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/category/disable?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_category",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/category/delete?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105"
                            } );
                                                                                                                                                                                    

                    grid_categoryoTable = $('#grid_category').dataTable({
                        "bPaginate":true,
                        "bRetrieve":true,
                        "bFilter": true,
                        ...
                        "oColumnFilterWidgets": {
                            ...
                            "aiExclude": [ 
                                            0,1            
                                                    ...
                                                    grid_categoryoTable.rowGrouping({ 
