...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/enabled?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/disable?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/delete?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105"
                            } );
