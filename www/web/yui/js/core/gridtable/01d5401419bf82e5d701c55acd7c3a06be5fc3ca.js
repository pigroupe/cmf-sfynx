                    ...
                    function fnCreateFooterFilter() 
                    {
                        ...
                        $("table th").each( function ( i ) {
                                ...
                                if (column != undefined) {
                                	                                    if (values == undefined) {
                                        values = grid_wordoTable.fnGetColumnData(column) 
                                    }
                                    if (type != "input") {
                                        var options = [];
                                        ...
                                        $('select', this).change( function () {
                                            ...
                                            grid_wordoTable.fnFilter( values, column, true );
                                        });
                                            ...
                                            filter: function(e, matches) {
                                                ...
                                                if ( (ajaxsearch === true) || (ajaxsearch === 'true') ) {
                                                	if(keyword != $(e.target).data('keyword')) {
                                                    	grid_wordoTable.fnFilter( keyword, column, true );
                                                	}
                                            	}
                                            }
                                        });                                        
                                        ...
                                        $(this).find('input').width('91%').attr('id', 'input_'+i).data('title', title).data('column', column).keyup( function () {
                                            ...
                                            search_timeout = setTimeout(function() {
                                              ...
                                              grid_wordoTable.fnFilter( $this.value, column, true );
                                            }, 1000);
                                        } );
                                    }
...
/*
                        $("[id^='select_']").change( function () {
                            ...
                            grid_wordoTable.fnFilter( values, $(this).data('column'), true );
                        });
                        $("[id^='select_']").multiselect({
                            ...
                            filter: function(e, matches) {
                                ...
                                var keyword = $('.ui-multiselect-filter:visible').find('input').val();
                                if(keyword != $(e.target).data('keyword')) {
                                    grid_wordoTable.fnFilter( keyword, $(this).data('column'), true );
                                }
                            }
                        });
                        var foo_input = function() {
                            grid_wordoTable.fnFilter( $(this).val(), $(this).data('column'), true );
                        };
...
*/
                    ...
                    $('#grid_word tbody tr').each(function(index) {
                        $(this).find("td.position").prependTo(this);
                    });
                    $('#grid_word thead tr').each(function(index) {
                    ...
                    $("tfooter input").keyup( function () {
                        grid_wordoTable.fnFilter( this.value, grid_wordoTable.oApi._fnVisibleToColumnIndex( 
                                grid_wordoTable.fnSettings(), $("thead input").index(this) ) );
                    } );
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_word",
                                //"display": "envelope",
                                "ajaxUrl": "/bootstrap/translator/enabled?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_word",
                                //"display": "envelope",
                                "ajaxUrl": "/bootstrap/translator/disable?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_word",
                                //"display": "envelope",
                                "ajaxUrl": "/bootstrap/translator/delete?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105"
                            } );
                                                                                                                                                                                    

                    grid_wordoTable = $('#grid_word').dataTable({
                        "bPaginate":false,
                        "bRetrieve":true,
                        "bFilter": true,
                        ...
                        "oColumnFilterWidgets": {
                            ...
                            "aiExclude": [ 
                                ...
                                oShowEffect: { method: "show", duration: "slow", easing: "linear" },
                                                    ...
                                                    grid_wordoTable.rowReordering({ 
                                  sURL:"/bootstrap/translator/position?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                  sRequestType: "GET",
                                                                    bGroupingUsed: true,
