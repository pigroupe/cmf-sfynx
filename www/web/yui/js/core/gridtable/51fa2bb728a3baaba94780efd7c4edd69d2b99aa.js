...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/enabled?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/disable?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/delete?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299"
                            } );
                                                                                                                                                                                                                                                                        // Set up archive row
                            defaultrow_rows_default_deletetwigcache = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",fnServerData
                                "ajaxUrl": "/admin/pagebytrans/deletetwigcache?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299"
                            } );                            
