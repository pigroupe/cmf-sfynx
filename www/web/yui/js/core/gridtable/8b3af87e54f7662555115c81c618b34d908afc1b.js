                    ...
                    function fnCreateFooterFilter() 
                    {
                        ...
                        $("table th").each( function ( i ) {
                                ...
                                if (column != undefined) {
                                	                                    if (values == undefined) {
                                        values = grid_cssjsoTable.fnGetColumnData(column) 
                                    }
                                    if (type != "input") {
                                        var options = [];
                                        ...
                                        $('select', this).change( function () {
                                            ...
                                            grid_cssjsoTable.fnFilter( values, column, true );
                                        });
                                            ...
                                            filter: function(e, matches) {
                                                ...
                                                if ( (ajaxsearch === true) || (ajaxsearch === 'true') ) {
                                                	if(keyword != $(e.target).data('keyword')) {
                                                    	grid_cssjsoTable.fnFilter( keyword, column, true );
                                                	}
                                            	}
                                            }
                                        });                                        
                                        ...
                                        $(this).find('input').width('91%').attr('id', 'input_'+i).data('title', title).data('column', column).keyup( function () {
                                            ...
                                            search_timeout = setTimeout(function() {
                                              ...
                                              grid_cssjsoTable.fnFilter( $this.value, column, true );
                                            }, 1000);
                                        } );
                                    }
...
/*
                        $("[id^='select_']").change( function () {
                            ...
                            grid_cssjsoTable.fnFilter( values, $(this).data('column'), true );
                        });
                        $("[id^='select_']").multiselect({
                            ...
                            filter: function(e, matches) {
                                ...
                                var keyword = $('.ui-multiselect-filter:visible').find('input').val();
                                if(keyword != $(e.target).data('keyword')) {
                                    grid_cssjsoTable.fnFilter( keyword, $(this).data('column'), true );
                                }
                            }
                        });
                        var foo_input = function() {
                            grid_cssjsoTable.fnFilter( $(this).val(), $(this).data('column'), true );
                        };
...
*/
                    ...
                    $('#grid_cssjs tbody tr').each(function(index) {
                        $(this).find("td.position").prependTo(this);
                    });
                    $('#grid_cssjs thead tr').each(function(index) {
                    ...
                    $("tfooter input").keyup( function () {
                        grid_cssjsoTable.fnFilter( this.value, grid_cssjsoTable.oApi._fnVisibleToColumnIndex( 
                                grid_cssjsoTable.fnSettings(), $("thead input").index(this) ) );
                    } );
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_cssjs",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagecssjs/enabled?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_cssjs",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagecssjs/disable?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                    ...
                    grid_cssjsoTable = $('#grid_cssjs').dataTable({
                        "bPaginate":true,
                        "bRetrieve":true,
                        "bFilter": true,
