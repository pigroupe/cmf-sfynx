...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                ...
                                //"display": "envelope",
                                "ajaxUrl": "/admin/users/enabled?_token=6dec4ea49b4e84ffc4d115dbf0f9f1b1053562a5",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/disable?_token=6dec4ea49b4e84ffc4d115dbf0f9f1b1053562a5",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            archiverow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/archive?_token=6dec4ea49b4e84ffc4d115dbf0f9f1b1053562a5"
                            } );                            
