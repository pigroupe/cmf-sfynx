...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_cssjs",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagecssjs/enabled?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_cssjs",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagecssjs/disable?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
