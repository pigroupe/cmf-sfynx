...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_media",
                                //"display": "envelope",
                                "ajaxUrl": "/content/gedmo/media/enabled?_token=66f0abde4c6604ba9ca8b734c04931153aa6ec2d",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_media",
                                //"display": "envelope",
                                "ajaxUrl": "/content/gedmo/media/disable?_token=66f0abde4c6604ba9ca8b734c04931153aa6ec2d",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
