...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                ...
                                //"display": "envelope",
                                "ajaxUrl": "/admin/users/enabled?_token=64add7ee19db288c7c191caa6c90952506670adb",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/disable?_token=64add7ee19db288c7c191caa6c90952506670adb",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            archiverow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_customer",
                                //"display": "envelope",
                                "ajaxUrl": "/users/archive?_token=64add7ee19db288c7c191caa6c90952506670adb"
                            } );                            
