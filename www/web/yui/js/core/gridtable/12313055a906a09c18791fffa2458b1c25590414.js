                    ...
                    {
                        $('#grid_contact').dataTable().fnFilter( 
                            $("#global_filter").val(),
                            null, 
                    ...
                    function fnCreateFooterFilter() 
                    {
                        ...
                        $("table th").each( function ( i ) {
                                ...
                                if (column != undefined) {
                                	                                    if (values == undefined) {
                                        values = grid_contactoTable.fnGetColumnData(column) 
                                    }
                                    if (type != "input") {
                                        var options = [];
                                        ...
                                        $('select', this).change( function () {
                                            ...
                                            grid_contactoTable.fnFilter( values, column, true );
                                        });
                                            ...
                                            filter: function(e, matches) {
                                                ...
                                                if ( (ajaxsearch === true) || (ajaxsearch === 'true') ) {
                                                	if(keyword != $(e.target).data('keyword')) {
                                                    	grid_contactoTable.fnFilter( keyword, column, true );
                                                	}
                                            	}
                                            }
                                        });                                        
                                        ...
                                        $(this).find('input').width('91%').attr('id', 'input_'+i).data('title', title).data('column', column).keyup( function () {
                                            ...
                                            search_timeout = setTimeout(function() {
                                              ...
                                              grid_contactoTable.fnFilter( $this.value, column, true );
                                            }, 1000);
                                        } );
                                    }
...
/*
                        $("[id^='select_']").change( function () {
                            ...
                            grid_contactoTable.fnFilter( values, $(this).data('column'), true );
                        });
                        $("[id^='select_']").multiselect({
                            ...
                            filter: function(e, matches) {
                                ...
                                var keyword = $('.ui-multiselect-filter:visible').find('input').val();
                                if(keyword != $(e.target).data('keyword')) {
                                    grid_contactoTable.fnFilter( keyword, $(this).data('column'), true );
                                }
                            }
                        });
                        var foo_input = function() {
                            grid_contactoTable.fnFilter( $(this).val(), $(this).data('column'), true );
                        };
...
*/
                    ...
                    $('#grid_contact tbody tr').each(function(index) {
                        $(this).find("td.position").prependTo(this);
                    });
                    $('#grid_contact thead tr').each(function(index) {
                    ...
                    $("tfooter input").keyup( function () {
                        grid_contactoTable.fnFilter( this.value, grid_contactoTable.oApi._fnVisibleToColumnIndex( 
                                grid_contactoTable.fnSettings(), $("thead input").index(this) ) );
                    } );
					*/
                    
                                                                                                                                                        // Set up enabled row
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_contact",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/contact/enabled?_token=4f85ed2a735bbed84ec9b4be67a89ea6231dda36",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_contact",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/contact/disable?_token=4f85ed2a735bbed84ec9b4be67a89ea6231dda36",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_contact",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/gedmo/contact/delete?_token=4f85ed2a735bbed84ec9b4be67a89ea6231dda36"
                            } );
                                                                                                                                                                                    

                    grid_contactoTable = $('#grid_contact').dataTable({
                        "bPaginate":true,
                        "bRetrieve":true,
                        "bFilter": true,
                                                                                                ...
                                                                                                "formTitle": "Désactiver données",
                                                                                                  "question": function(b) {
                                                                                                      return "Voulez-vous désactiver " + b + " ligne" + (b === 1 ? " ?" : "s ?")
                                                                                                                                                        ...
                                                                                                                                                        {
                                                "sExtends": "editor_remove",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/remove.png?v1_0_0' title='Supprimer' alt='Supprimer'  />Supprimer",
                                                "editor": deleterow,
                                                "formButtons": [
                                                    {
                                                        "label": "Valider",
                        ...
                        "oColumnFilterWidgets": {
                            ...
                            "aiExclude": [ 
                                            0,1            
                                                    ...
                                                    grid_contactoTable.rowGrouping({ 
