...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/enabled?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/disable?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/layout/delete?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299"
                            } );
                    ...
                    gridoTable = $('#grid').dataTable({
                        ...
                        "oTableTools": {
                            ...
                            "aButtons": [
                                                ...
                                                "sExtends": "pdf",
                                                "sTitle": "Sfynx",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/export_pdf.png?v1_0_0' title='Export' alt='Export'  />PDF",
                                                ...
                                                "sExtends": "xls",
                                                "sTitle": "Sfynx",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/export_xls.png?v1_0_0' title='Export' alt='Export'  />XLS"
                                            },
