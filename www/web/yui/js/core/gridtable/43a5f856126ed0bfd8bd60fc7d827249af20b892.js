                    ...
                    function fnCreateFooterFilter() 
                    {
                        ...
                        $("table th").each( function ( i ) {
                                ...
                                if (column != undefined) {
                                	                                    if (values == undefined) {
                                        values = grid_alloTable.fnGetColumnData(column) 
                                    }
                                    if (type != "input") {
                                        var options = [];
                                        ...
                                        $('select', this).change( function () {
                                            ...
                                            grid_alloTable.fnFilter( values, column, true );
                                        });
                                            ...
                                            filter: function(e, matches) {
                                                ...
                                                if ( (ajaxsearch === true) || (ajaxsearch === 'true') ) {
                                                	if(keyword != $(e.target).data('keyword')) {
                                                    	grid_alloTable.fnFilter( keyword, column, true );
                                                	}
                                            	}
                                            }
                                        });                                        
                                        ...
                                        $(this).find('input').width('91%').attr('id', 'input_'+i).data('title', title).data('column', column).keyup( function () {
                                            ...
                                            search_timeout = setTimeout(function() {
                                              ...
                                              grid_alloTable.fnFilter( $this.value, column, true );
                                            }, 1000);
                                        } );
                                    }
...
/*
                        $("[id^='select_']").change( function () {
                            ...
                            grid_alloTable.fnFilter( values, $(this).data('column'), true );
                        });
                        $("[id^='select_']").multiselect({
                            ...
                            filter: function(e, matches) {
                                ...
                                var keyword = $('.ui-multiselect-filter:visible').find('input').val();
                                if(keyword != $(e.target).data('keyword')) {
                                    grid_alloTable.fnFilter( keyword, $(this).data('column'), true );
                                }
                            }
                        });
                        var foo_input = function() {
                            grid_alloTable.fnFilter( $(this).val(), $(this).data('column'), true );
                        };
...
*/
                    ...
                    $('#grid_all tbody tr').each(function(index) {
                        $(this).find("td.position").prependTo(this);
                    });
                    $('#grid_all thead tr').each(function(index) {
                    ...
                    $("tfooter input").keyup( function () {
                        grid_alloTable.fnFilter( this.value, grid_alloTable.oApi._fnVisibleToColumnIndex( 
                                grid_alloTable.fnSettings(), $("thead input").index(this) ) );
                    } );
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/enabled?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/disable?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
                            ...
                            deleterow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/pagebytrans/delete?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105"
                            } );
                                                                                                                                                                                                                                                                        // Set up archive row
                            defaultrow_rows_default_deletetwigcache = new $.fn.dataTable.Editor( {
                                "domTable": "#grid_all",
                                //"display": "envelope",fnServerData
                                "ajaxUrl": "/admin/pagebytrans/deletetwigcache?_token=7a920b54c02769dbb6c1eea04aac4027d16c9105"
                            } );                            
                                                                            

                    grid_alloTable = $('#grid_all').dataTable({
                        "bPaginate":true,
                        "bRetrieve":true,
                        "bFilter": true,
                        ...
                        //avec multi-filtre : "sDom": '<"block_filter"><"H"RTfr<"clear">W>tC<"F"lpi>',
                                                                                "sDom": '<"H"RTfr<"clear">W<"clear">p<"clear">>tC<"F"lpi>',
                                                                                                ...
                                                                                                "formTitle": "Suppression de données",
                                                                                                  "question": function(b) {
                                                                                                      return "Voulez-vous supprimer " + b + " ligne" + (b === 1 ? " ?" : "s ?")
                                                                                                    		                                            ...
                                                                                                    		                                            {
                                                "sExtends": "copy",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/copy.png?v1_0_0' title='Copy to clipboard' alt='Copy to clipboard'  />Copy to clipboard",
                                            },
                                                                            
                                                                                                    		                                            {
                                                "sExtends": "print",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/print.png?v1_0_0' title='Print table' alt='Print table'  />Print table",
                                            },
                                                                            
                                                                                                    		                                                                                        {
                                                "sExtends":    "collection",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/export_all.png?v1_0_0' title='Export' alt='Export'  />Export",
                                                "aButtons":    [ 
                                                                 {
                                                                     "sExtends": "csv",
                                                                     "sTitle": "Sfynx"
                                                                 ...
                                                                 },
                                                                 {
                                                                    ...
                                                                    "sPdfMessage": "PDF export (2015/04/24)",
                                                                    "sTitle": "Sfynx"
                                                                 }
                                                 ]
                                            },
                                                                                                                                                        ...
                                                                                                                                                        {
                                                "sExtends": "editor_remove",
                                                "sButtonText": "<img class='btn-action' src='/bundles/sfynxsmoothness/admin/grid/img/delete_cache.png'  title='Clear cache'>Clear cache",
                                                "editor": defaultrow_rows_default_deletetwigcache,
                                                "formButtons": [
                                                    {
                                                        "label": "Valider",
                                                        "className": "save",
                                                        "fn": function (e) {
                                                            this.submit(function(){
                                                                                                ...
                                                                                                "formTitle": "Clear cache",
                                                                                                  "question": function(b) {
                                                                                                        return "Voulez-vous vider le cache ?"
