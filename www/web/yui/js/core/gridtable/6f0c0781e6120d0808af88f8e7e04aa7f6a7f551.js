...
*/
					...
					*/
                            ...
                            enabled = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/keyWord/enabled?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                            ...
                            disablerow = new $.fn.dataTable.Editor( {
                                "domTable": "#grid",
                                //"display": "envelope",
                                "ajaxUrl": "/admin/keyWord/disable?_token=3d6f257f8be2ec1335bdf617a8d4e8a14165b299",
                                "events": {
                                    "onPreSubmit": function (data) {
                                    },
                                    "onPostSubmit": function (json, data) {
