                ...
                var j_prototype_bytabs = new function()
                {
                    ...
                    this.ftc_addTab = function(index){
                                                //tabs.tabs('add', '#tabs-' + tab_counter, 'Translate ' + index);
                                                var label = "Translate " + index;
                    ...
                    this.ftc_tinymce_editor = function(idObj){
                        idObj.tinymce({
                            ...
                            script_url : 'http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/tiny_mce_src.js',
                            // General options
                            theme : "advanced",
                            language : "en",
        ...
        ,
                            ...
                            template_external_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/template_list.js",
                            external_link_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/link_list.js",
                            external_image_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/image_list.js",
                            media_external_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/media_list.js",
                    ...
                    this.ftc_tinymce_editor_simple = function(idObj){
                        idObj.tinymce({
                            // Location of TinyMCE script
                            script_url : 'http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/tiny_mce.js',
                            // General options
                            theme : "advanced",
                            language : "en",
                            plugins : "openmanager,autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist",
        ...
        ,
                            font_size_classes : "tt-10,tt-9,tt-8,tt-7,tt-6,tt-4,tt-2",
                            // Drop lists for link/image/media/template dialogs
                            template_external_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/template_list.js",
                            external_link_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/link_list.js",
                            external_image_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/image_list.js",
                            media_external_list_url : "http://test.sfynx.local/bundles/sfynxtemplate/js/tiny_mce/plugins/lists/media_list.js",
                            // count without the lenght of html balise
