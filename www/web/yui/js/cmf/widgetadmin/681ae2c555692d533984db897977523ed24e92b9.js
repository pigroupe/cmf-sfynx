                    ...
                    $("span[class^='page_action_']").click( function() {
                        ...
                        if (_class == "page_action_archivage"){
                            ...
                            $.ajax({
                                ...
                                $('#page-action-dialog').html("Vous avez indexé la page avec succès !");
                                $('#page-action-dialog').attr('title', 'Indexation de page');
                        ...
                        if (_class == "page_action_desarchivage"){
                            ...
                            $.ajax({
                                ...
                                $('#page-action-dialog').html("Vous avez supprimé l'indexation de la page avec succès !");
                                $('#page-action-dialog').attr('title', 'Suppression indexation de page');
                                $('#page-action-dialog').dialog({
                                      height: 180,
                                      width: 400,
                                        open: function () {
                        ...
                        if (_class == "page_action_edit"){
                            ...
                            $.ajax({
                                ...
                                data: "type=page&action=edit&routename=admin_gedmo_contact_new",
                                datatype: "json",
                                cache: false,
                                cache: false,
                                "beforeSend": function ( xhr ) {
                                ...
                                $("#page-action-dialog").html('<iframe id="modalIframeId" width="100%" height="99%" style="overflow-x: hidden; overflow-y: auto" marginWidth="0" marginHeight="0" frameBorder="0" src="'+url+'" />').dialog({
                                     ...
                                     height: height/1.5,
                                     open: function () {
                                         $(this).attr('title', 'Modification de la page');
                                     },
                                     beforeClose: function () {
                        ...
                        if (_class == "page_action_new"){
                            ...
                            $.ajax({
                                ...
                                $("#page-action-dialog").html('<iframe id="modalIframeId" width="100%" height="99%" style="overflow-x: hidden; overflow-y: auto" marginWidth="0" marginHeight="0" frameBorder="0" src="'+url+'" />').dialog({
                                     ...
                                     height: height/1.5,
                                     open: function () {
                                         $(this).attr('title', 'Creation de la page');
                                     },
                                     beforeClose: function () {
                                ...
                                $('#widget-action-dialog').dialog({
                                    ...
                                    open: function () {
                                        ...
                                        if (_class == "widget_action_delete")
                                            $(this).html('Êtes-vous sûr de vouloir supprimer le Widget ?');
                                        if (_class == "widget_action_move_up")
                                            $(this).html('Êtes-vous sûr de vouloir déplacer vers le haut le Widget ?');
                                        if (_class == "widget_action_move_down")
                                            $(this).html('Êtes-vous sûr de vouloir déplacer vers le bas le Widget ?');
