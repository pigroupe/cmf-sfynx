-----------------------------------------------------
DemoContext\\Domain\\Service\\User\\Event\\UserEvents
-----------------------------------------------------

.. php:namespace: DemoContext\\Domain\\Service\\User\\Event

.. php:class:: UserEvents

    .. php:const:: USER_EVENT_PREPERSIST
    ...
    .. php:const:: USER_EVENT_POSTPERSIST
    ...
    .. php:const:: USER_EVENT_POSTREMOVE
    ...
    .. php:const:: USER_EVENT_POSTFLUSH
