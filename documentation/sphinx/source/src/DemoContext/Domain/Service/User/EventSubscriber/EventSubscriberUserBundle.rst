------------------------------------------------------------------------------
DemoContext\\Domain\\Service\\User\\EventSubscriber\\EventSubscriberUserBundle
------------------------------------------------------------------------------

.. php:namespace: DemoContext\\Domain\\Service\\User\\EventSubscriber

.. php:class:: EventSubscriberUserBundle
    ...
    .. php:method:: dispatchUser(EventArgs $eventArgs, $const)
