sub devicedetect {
    ...
    if (req.http.Cookie ~ "(?i)X-UA-Device-force") {
        ...
        if (
           (req.http.User-Agent ~ "(?i)\biPhone.*(Mobile|PhoneGap)|\biPod") ||
           ...
           (req.http.User-Agent ~ "(?i)Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*Mobile") ||
           ...
           (req.http.User-Agent ~ "(?i)\bLG\b;|LG[- ]?(C800|C900|E400|E610|E900|E-900|F160|F180K|F180L|F180S|730|855|L160|LS840|LS970|LU6200|MS690|MS695|MS770|MS840|MS870|MS910|P500|P700|P705|VM696|AS680|AS695|AX840|C729|E970|GS505|272|C395|E739BK|E960|L55C|L75C|LS696|LS860|P769BK|P350|P500|P509|P870|UN272|US730|VS840|VS950|LN272|LN510|LS670|LS855|LW690|MN270|MN510|P509|P769|P930|UN200|UN270|UN510|UN610|US670|US740|US760|UX265|UX840|VN271|VN530|VS660|VS700|VS740|VS750|VS910|VS920|VS930|VX9200|VX11000|AX840A|LW770|P506|P925|P999|E612|D955|D802)") ||
           (req.http.User-Agent ~ "(?i)SonyST|SonyLT|SonyEricsson|SonyEricssonLT15iv|LT18i|E10i|LT28h|LT26w|SonyEricssonMT27i") ||
        ...
        if (
           ...
           (req.http.User-Agent ~ "(?i)Android.*Nexus[\s]+(7|10)|^.*Android.*Nexus(?:(?!Mobile).)*$") ||
           ...
           (req.http.User-Agent ~ "(?i)Kindle|Silk.*Accelerated|Android.*\b(KFOT|KFTT|KFJWI|KFJWA|KFOTE|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|WFJWAE)\b") ||
           (req.http.User-Agent ~ "(?i)Windows NT [0-9.]+; ARM;") ||
           (req.http.User-Agent ~ "(?i)HP Slate 7|HP ElitePad 900|hp-tablet|EliteBook.*Touch|HP 8") ||
           (req.http.User-Agent ~ "(?i)^.*PadFone((?!Mobile).)*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|\bK00F\b|TX201LA") ||
           (req.http.User-Agent ~ "(?i)PlayBook|RIM Tablet") ||
           (req.http.User-Agent ~ "(?i)HTC Flyer|HTC Jetstream|HTC-P715a|HTC EVO View 4G|PG41200") ||
           ...
           (req.http.User-Agent ~ "(?i)Android.*; \b(A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810|A1-830)\b|W3-810|\bA3-A10\b") ||
           ...
           (req.http.User-Agent ~ "(?i)\bL-06C|LG-V900|LG-V500|LG-V909|LG-V500|LG-V510|LG-VK810\b") ||
           ...
           (req.http.User-Agent ~ "(?i)IdeaTab|ThinkPad([ ]+)?Tablet|Lenovo.*(S2109|S2110|S5000|S6000|K3011|A3000|A1000|A2107|A2109|A1107|B6000|B8000|B8080-F)") ||
           ...
           (req.http.User-Agent ~ "(?i)AN10G2|AN7bG3|AN7fG3|AN8G3|AN8cG3|AN7G3|AN9G3|AN7dG3|AN7dG3ST|AN7dG3ChildPad|AN10bG3|AN10bG3DT") ||
           (req.http.User-Agent ~ "(?i)INM8002KP|INM1010FP|INM805ND|Intenso Tab") ||
           ...
           (req.http.User-Agent ~ "(?i)\b(101G9|80G9|A101IT)\b|Qilive 97R|ARCHOS 101G10|Archos 101 Neon") ||
           ...
           (req.http.User-Agent ~ "(?i)ST10416-1|VT10416-1|ST70408-1|ST702xx-1|ST702xx-2|ST80208|ST97216|ST70104-2|VT10416-2|ST10216-2A") ||
           ...
           (req.http.User-Agent ~ "(?i)SmartTab([ ]+)?[0-9]+|SmartTabII10") ||
           ...
           (req.http.User-Agent ~ "(?i)LOOX|XENO10|ODYS Space") ||
