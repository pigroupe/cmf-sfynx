...
sed -i "s/MyApp\\SiteBundle/${DOMAINE}\\${MYAPP_BUNDLE_NAME}/g" src/${DOMAINE}/${MYAPP_BUNDLE_NAME}Bundle/*
sed -i "s/MyAppSiteBundle/${DOMAINE}${MYAPP_BUNDLE_NAME}Bundle/g" src/${DOMAINE}/${MYAPP_BUNDLE_NAME}Bundle/*
...
if ! grep -q "${DOMAINE}${MYAPP_BUNDLE_NAME}Bundle" app/config/routing.yml; then
