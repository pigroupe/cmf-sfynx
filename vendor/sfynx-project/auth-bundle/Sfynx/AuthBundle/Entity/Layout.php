...
/**
 * Sfynx\AuthBundle\Entity\Layout
 *
 * @ORM\Table(name="pi_layout")
 * @ORM\Entity(repositoryClass="Sfynx\AuthBundle\Repository\LayoutRepository")
...
class Layout
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Sfynx\AuthBundle\Entity\Role", mappedBy="layout", cascade={"persist"})
     */
    protected $roles;    
