...
class ResettingController extends ContainerAware
{
    ...
    public function requestAction()
    {
        ...
        return $this->container->get('templating')->renderResponse(str_replace('::', ':', $this->container->getParameter('sfynx.auth.theme.login')).'Resetting:request.html.twig', array('NoLayout' => $NoLayout));
    }
    ...
    public function sendResettingEmailMessage(UserInterface $user, $route_reset_connexion)
    {
        ...
        $rendered = $this->container->get('templating')->render(str_replace('::', ':', $this->container->getParameter('sfynx.auth.theme.login')).'Resetting:email.txt.twig', array(
            'user'                 => $user,
            'confirmationUrl'     => $html_url,
        ));
        $this->container->get("sfynx.tool.mailer_manager")->send("administrator@gmail.com", $user->getEmail(), "Changement de mot de passe", $rendered);
    }
    ...
    public function checkEmailAction()
    {
        ...
        return $this->container->get('templating')->renderResponse(str_replace('::', ':', $this->container->getParameter('sfynx.auth.theme.login')).'Resetting:checkEmail.html.twig', array(
            'email' => $email,
        ));
    }
    ...
    public function resetAction(Request $request, $token)
    {
        ...
        return $this->container->get('templating')->renderResponse(str_replace('::', ':', $this->container->getParameter('sfynx.auth.theme.login')).'Resetting:reset.html.twig', array(
            'token' => $token,
