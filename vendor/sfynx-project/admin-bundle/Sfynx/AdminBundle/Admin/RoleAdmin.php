...
class RoleAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->end()
            ->with('Heritage')
                ->add('heritage', 'sfynx_security_roles', array( 'multiple' => true, 'required' => false, 'expanded' => true))
            ->end()
            ->with('Redirection')
                ->add('route_login', 'sfynx_routes', array( 'multiple' => false, 'required' => false))
                ->add('route_logout', 'sfynx_routes', array( 'multiple' => false, 'required' => false))
