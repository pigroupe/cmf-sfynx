 ...
 */
namespace Sfynx\CmfBundle\Manager\FormBuilder;  
...
class PiModelWidgetSnippet extends PiFormBuilderManager
{
    ...
    public function renderScript(array $option)
     {
        ...
        return  $this->container->get('sfynx.tool.script_manager')->renderScript($_content_js, "", 'formbuilder/cmf/snippet/');
    }        
    ...
    public function preEventBindRequest(){
        $this->_createentity    =     new  \Sfynx\CmfBundle\Entity\Widget();
