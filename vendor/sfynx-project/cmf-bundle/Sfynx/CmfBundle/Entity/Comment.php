...
/**
 * Sfynx\CmfBundle\Entity\Comment
 * 
 * @ORM\Table(name="pi_comment")
 * @ORM\Entity(repositoryClass="Sfynx\CmfBundle\Repository\CommentRepository")
...
class Comment
{
    ...
    /**
     * @var \Sfynx\CmfBundle\Entity\TranslationPage $pageTranslation
     * 
     * @ORM\ManyToOne(targetEntity="Sfynx\CmfBundle\Entity\TranslationPage", inversedBy="comments", cascade={"persist"})
