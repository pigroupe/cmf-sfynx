...
/**
 * Sfynx\CmfBundle\Entity\Tag
 *
 * @ORM\Table(name="pi_tag")
 * @ORM\Entity(repositoryClass="Sfynx\CmfBundle\Repository\TagRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Sfynx\CmfBundle\Entity\Translation\TagTranslation")
 * @UniqueEntity("name")
 * 
 * @category   Cmf
 * @package    Entity
...
class Tag extends AbstractTranslation
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Sfynx\CmfBundle\Entity\Translation\TagTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Sfynx\CmfBundle\Entity\Translation\TagTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
