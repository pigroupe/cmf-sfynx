...
use Sfynx\CmfBundle\Validator\Constraints as MyAssert;
use Sfynx\AuthBundle\Repository\RoleRepository;

/**
 * Sfynx\CmfBundle\Entity\TranslationPage
 *
...
class TranslationPage
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="Sfynx\CmfBundle\Entity\Page", inversedBy="translations", cascade={"persist"})
     ...
     * 
     * @ORM\ManyToMany(targetEntity="Sfynx\CmfBundle\Entity\Tag")
     ...
     * 
     * @ORM\OneToMany(targetEntity="Sfynx\CmfBundle\Entity\Comment", mappedBy="pageTranslation", cascade={"all"})
     */
    protected $comments;   
     ...
     * 
     * @ORM\OneToMany(targetEntity="Sfynx\CmfBundle\Entity\HistoricalStatus", mappedBy="pageTranslation", cascade={"all"})
     */
...
//     }
     ...
     * Add tag
     *
     * @param \Sfynx\CmfBundle\Entity\Tag
     */
    public function addTag(\Sfynx\CmfBundle\Entity\Tag $tag)
    {
        $this->tags[] = $tag;
    }
     ...
     * remove tag
     *
     * @param  \Sfynx\CmfBundle\Entity\Tag $tag
     */
    public function removeTag(\Sfynx\CmfBundle\Entity\Tag $tag)
    {
     ...
     * Add comments
     *
     * @param \Sfynx\CmfBundle\Entity\Comment
     */
    public function addComment(\Sfynx\CmfBundle\Entity\Comment $comments)
    {
     ...
     *
     * @param \Sfynx\CmfBundle\Entity\HistoricalStatus
     */
    public function addHistoricalStatus(\Sfynx\CmfBundle\Entity\HistoricalStatus $historicalStatus)
    {
