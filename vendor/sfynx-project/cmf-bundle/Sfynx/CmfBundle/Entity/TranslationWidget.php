...
/**
 * Sfynx\CmfBundle\Entity\TranslationWidget
 *
 * @ORM\Table(name="pi_widget_translation")
 * @ORM\Entity(repositoryClass="Sfynx\CmfBundle\Repository\TranslationWidgetRepository")
...
class TranslationWidget
{
    ...
    /**
     * @var \Sfynx\CmfBundle\Entity\Widget $widget
     * 
     * @ORM\ManyToOne(targetEntity="Sfynx\CmfBundle\Entity\Widget", inversedBy="translations", cascade={"persist"})
     ...
     *
     * @ORM\ManyToOne(targetEntity="Sfynx\AuthBundle\Entity\Langue", cascade={"persist", "refresh"})
...
//     }   
     ...
     * Set widget
     *
     * @param \Sfynx\CmfBundle\Entity\Widget
     */
    public function setWidget(\Sfynx\CmfBundle\Entity\Widget $widget)
    {
        $this->widget = $widget;
    }
