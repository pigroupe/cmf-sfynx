...
/**
 * Sfynx\CmfBundle\Entity\Block
 *
 * @ORM\Table(name="pi_block")
 * @ORM\Entity(repositoryClass="Sfynx\CmfBundle\Repository\BlockRepository")
...
class Block
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="Sfynx\CmfBundle\Entity\Page", inversedBy="blocks", cascade={"persist"})
     ...
     * 
     * @ORM\OneToMany(targetEntity="Sfynx\CmfBundle\Entity\Widget", mappedBy="block", cascade={"all"})
     * @Assert\Valid
     */
    protected $widgets;
     ...
     */
    public function setPage(\Sfynx\CmfBundle\Entity\Page $page)
    {
        $this->page = $page;
    }
     ...
     * 
     */
    public function addWidget(\Sfynx\CmfBundle\Entity\Widget $widgets)
    {
