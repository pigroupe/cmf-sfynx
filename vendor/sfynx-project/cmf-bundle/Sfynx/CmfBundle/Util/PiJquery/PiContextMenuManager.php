...
class PiContextMenuManager extends PiJqueryExtension
{
    ...
    {
        // css
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/js/contextmenu/css/blockpage.css");
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/js/contextmenu/css/contextmenu.css");
        
        // js
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/js/contextmenu/js/jquery.contextmenu.js");
    }    
