...
class PiDialogManager extends PiJqueryExtension
{
    ...
    protected function init($options = null) {
        // js
        //$this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/");
        
        //css
        //$this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/");
    }    
    ...
    {        
        ...
        return  $this->renderScript($_content_js, '', 'cmf/dialog/');
    }    
}