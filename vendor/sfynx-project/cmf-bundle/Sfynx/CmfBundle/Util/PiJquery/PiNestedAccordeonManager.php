...
class PiNestedAccordeonManager extends PiJqueryExtension
{
    ...
    {
        // css
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/js/nested/css/style.css");
        // js
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/js/nested/js/jquery.nestedAccordion.js");
 ...
 */        
        ...
        return  $this->renderScript($_content_js, '', 'cmf/nestedaccordeon/accordeonUl/');
    }    
 ...
 */        
        ...
        return  $this->renderScript($_content_js, '', 'cmf/nestedaccordeon/accordeonDiv/');
    } 
 ...
 */        
        ...
        return  $this->renderScript($_content_js, '', 'cmf/nestedaccordeon/accordeonTree/');
    }     
