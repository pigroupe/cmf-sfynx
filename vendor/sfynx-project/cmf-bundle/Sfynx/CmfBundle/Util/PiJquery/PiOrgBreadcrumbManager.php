...
use Sfynx\CmfBundle\Manager\PiTreeManager;
...
class PiOrgBreadcrumbManager extends PiJqueryExtension
{
    ...
    private function renderdefaultAction($parameters, $options = null)
    {
        ...
        if (!is_null($parameters['node'])){
            ...
            $templateContent = $this->container->get('twig')->loadTemplate("SfynxTemplateBundle:Template\\Breadcrumb:$template");
            ...
            foreach($nodes as $key => $node){
                    ...
                    if ($templateContent->hasBlock("boucle")){
                        ...
                        $response     = $this->container->get('templating')->renderResponse("SfynxTemplateBundle:Template\\Breadcrumb:$template", $parameters);
