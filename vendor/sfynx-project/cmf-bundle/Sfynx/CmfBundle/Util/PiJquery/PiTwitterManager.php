...
class PiTwitterManager extends PiJqueryExtension
{
    ...
    protected function init($options = null) {
        // js
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/js/timeago/timeago.js");
    }
    ...
    protected function rendertwitterAction($options = null)
    {
        ...
        $response = $this->container
                        ->get('templating')
                        ->renderResponse("SfynxTemplateBundle:Template\\Twitter:$template", array('jsonUrl' => $jsonUrl, "order" => $order, 'refreshInterval' => $refreshInterval));
    ...
    protected function rendertwitterwithrssAction($options = null)
    {
        ...
        $response = $this->container
                    ->get('templating')
                    ->renderResponse("SfynxTemplateBundle:Template\\Twitter:$template", array('jsonUrl' => $jsonUrl, "order" => $order, 'refreshInterval' => $refreshInterval,'entities_rss' => $entities_rss));
