...
class PiTinyAccordeonManager extends PiJqueryExtension
{
    ...
    protected function init($options = null) {
        // css
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/js/tiny_accordion/css/style.css");
        // js
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/js/tiny_accordion/js/script.js");
    }    
