...
class PiVeneerManager extends PiJqueryExtension
{
    ...
    protected function init($options = null) {
        // js
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addJsFile("bundles/sfynxtemplate/js/ui/veneer/js/jquery.ui.veneer.js");
        
        //css
        $this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile("bundles/sfynxtemplate/js/ui/veneer/css/jquery.ui.veneer.css");
    }    
    ...
    {        
        ...
        return  $this->renderScript($_content_js, '', 'cmf/veneer/');
    }    
}