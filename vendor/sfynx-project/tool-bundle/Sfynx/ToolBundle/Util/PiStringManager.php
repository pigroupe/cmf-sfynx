...
use Sfynx\ToolBundle\Builder\PiStringManagerBuilderInterface;

/**
 * Description of string manager
 *
 * <code>
 *     $StringFormatter    = $container->get('sfynx.tool.string_manager');
...
class PiStringManager implements PiStringManagerBuilderInterface
{
     ...
     * 
     * <code>
     * 	$this->get("sfynx.tool.string_manager")->remove_whitespace_feed($string);
     * </code>
     * 
     * @param string $string
     * @param string $motif
