 ...
 */
namespace Sfynx\CacheBundle\Command;
 ...
 * 
 * <code>
 *   php app/console sfynx:cacheclient:stats
 *   php app/console help sfynx:cacheclient:stats
...
class CacheClientStatsCommand extends ContainerAwareCommand
{
   ...
   {
      $this
        ->setName('sfynx:cacheclient:stats')
   ...
   protected function execute(InputInterface $input, OutputInterface $output)
   {
     ...
     $client = $this->getContainer()->get( 'sfynx.cache.memcache.client' );
