...
class PiFormSimpleManager extends PiJqueryExtension
{
    ...
    {
        // css theme
        //$this->container->get('sfynx.tool.twig.extension.layouthead')->addCssFile($this->container->getParameter('sfynx.auth.theme.layout.admin.form.css'));
    ...
    {        
        ...
        return  $this->renderScript($_content_js, $_content_html, 'core/formsimple/');
    }    
}