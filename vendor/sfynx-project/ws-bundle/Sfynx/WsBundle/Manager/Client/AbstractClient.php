 ...
 */
namespace Sfynx\WsBundle\Manager\Client;
...
abstract class AbstractClient implements WsClientInterface
{
    ...
    /**
     * @var \Sfynx\ToolBundle\Util\PiRestManager
     */
    private $rest;
    ...
    public function __construct(ContainerInterface $container, $clientName)
    {
        ...
        $this->rest = $this->getContainer()->get('sfynx.tool.rest_manager');
    }
     ...
     * Gets rest manager.
     *
     * @return \Sfynx\ToolBundle\Util\PiRestManager
     * @access protected
     * @author Etienne de Longeaux <etienne.delongeaux@gmail.com>
     */
