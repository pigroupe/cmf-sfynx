...
use Plugins\ContentBundle\Entity\Rub;
use Plugins\ContentBundle\Form\RubType;
use Plugins\ContentBundle\Form\RubFavoriteType;
use PiApp\GedmoBundle\Form\CategorySearchForm;
use Plugins\ContentBundle\Entity\Translation\RubTranslation;
        ...
        $options = array(
                ...
                'nodeDecorator' => function($node) use (&$self) {
                    ...
                    if($node['lvl'] == 1) {
                    	...
                    	if ($tree->getParent() instanceof \Plugins\ContentBundle\Entity\Rub) {
