...
class TestType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder   
             ->add('enabled', 'hidden')
             ->add('blocgeneral', new \Plugins\ContentBundle\Form\BlocGeneralType($this->_em, $this->_container, "plugins_contentbundle_testtype_blocgeneral_media"))
             ->add('questions', 'collection', array(
                 'type' => new \Plugins\ContentBundle\Form\TestQuestionType($this->_em, $this->_container),
                 'allow_add' => true,
                 'allow_delete' => true,
                 'by_reference' => false,
            ))
