...
/**
 * Plugins\ContentBundle\Entity\Page
 * @ORM\Table(name="cont_page")
 * @ORM\Entity(repositoryClass="Plugins\ContentBundle\Repository\PageRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Plugins\ContentBundle\Entity\Translation\PageTranslation")
 *
...
class Page extends AbstractDefault 
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Plugins\ContentBundle\Entity\Translation\PageTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\Translation\PageTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="Plugins\ContentBundle\Entity\BlocGeneral" , cascade={"all"}, inversedBy="page");
