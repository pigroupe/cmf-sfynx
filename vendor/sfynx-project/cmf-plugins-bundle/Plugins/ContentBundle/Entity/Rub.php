...
/**
 * Plugins\ContentBundle\Entity\Rub
 *
 * @Gedmo\Tree(type="nested")
 * @ORM\Table(name="cont_rub")
 * @ORM\Entity(repositoryClass="Plugins\ContentBundle\Repository\RubRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Plugins\ContentBundle\Entity\Translation\RubTranslation")
 *
 * @UniqueEntity("title")
 * 
...
class Rub extends AbstractDefault 
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Plugins\ContentBundle\Entity\Translation\RubTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\Translation\RubTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\BlocGeneral", mappedBy="mainrub")
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\BlocGeneral", mappedBy="subrub")
     ...
     * @return Rub
     */
    public function setBlocgeneral2(\Plugins\ContentBundle\Entity\BlocGeneral $blocgeneral2 = null)
    {
     ...
     * @return Rub
     */
    public function setBlocgeneral(\Plugins\ContentBundle\Entity\BlocGeneral $blocgeneral = null)
    {
    ...
    /**
     * @var \Plugins\ContentBundle\Entity\Rub $parent
     *
     * @Gedmo\TreeParent
     * @ORM\ManyToOne(targetEntity="\Plugins\ContentBundle\Entity\Rub", inversedBy="childrens", cascade={"persist"})
     ...
     *
     * @ORM\OneToMany(targetEntity="\Plugins\ContentBundle\Entity\Rub", mappedBy="parent", cascade={"all"})
     * @ORM\OrderBy({"lft" = "ASC"})
     */
    protected $childrens;
     ...
     * Set parent
     *
     * @param \Plugins\ContentBundle\Entity\Rub    $parent
     */
