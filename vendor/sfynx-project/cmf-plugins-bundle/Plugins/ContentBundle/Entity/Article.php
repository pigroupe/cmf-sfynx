...
/**
 * Plugins\ContentBundle\Entity\Article
 * @ORM\Table(name="cont_article")
 * @ORM\Entity(repositoryClass="Plugins\ContentBundle\Repository\ArticleRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Plugins\ContentBundle\Entity\Translation\ArticleTranslation")
 *
...
class Article extends AbstractDefault 
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Plugins\ContentBundle\Entity\Translation\ArticleTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\Translation\ArticleTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="Plugins\ContentBundle\Entity\BlocGeneral" , cascade={"all"}, inversedBy="article");
