...
/**
 * Plugins\ContentBundle\Entity\TestQuestion
 * @ORM\Table(name="cont_test_question")
 * @ORM\Entity(repositoryClass="Plugins\ContentBundle\Repository\TestQuestionRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Plugins\ContentBundle\Entity\Translation\TestQuestionTranslation")
 *
...
class TestQuestion extends AbstractDefault 
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Plugins\ContentBundle\Entity\Translation\TestQuestionTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\Translation\TestQuestionTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Plugins\ContentBundle\Entity\Test", mappedBy="questions");
     */
    protected $test;
    ...
    public function addTest(\Plugins\ContentBundle\Entity\Test $test)
    {
        $this->test[] = $test;
