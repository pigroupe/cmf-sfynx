...
/**
 * Plugins\ContentBundle\Entity\Test
 * @ORM\Table(name="cont_test")
 * @ORM\Entity(repositoryClass="Plugins\ContentBundle\Repository\TestRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Plugins\ContentBundle\Entity\Translation\TestTranslation")
 *
...
class Test extends AbstractDefault 
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'Plugins\ContentBundle\Entity\Translation\TestTranslation';
    
    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="Plugins\ContentBundle\Entity\Translation\TestTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="Plugins\ContentBundle\Entity\BlocGeneral" , cascade={"all"}, inversedBy="test");
    ...
    /**
     *
     * @ORM\ManyToMany(targetEntity="Plugins\ContentBundle\Entity\TestQuestion", cascade={"all"}, inversedBy="test")
     ...
     * Remove questions
     *
     * @param \Plugins\ContentBundle\Entity\TestQuestion $questions
     */
    public function removeQuestions(\Plugins\ContentBundle\Entity\TestQuestion $questions)
    {
