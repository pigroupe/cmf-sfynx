...
use Cmf\ContentBundle\Form\BlocGeneralType;
use Cmf\ContentBundle\Entity\Translation\BlocGeneralTranslation;
        ...
        if ($request->isXmlHttpRequest() && $is_Server_side) {
           ...
           foreach ($result as $e) {
              // we set the resulmt to the $lang language value
           	  ...
           	  $em->refresh($e);
	          if ($e->getArticle() instanceof \Cmf\ContentBundle\Entity\Article) {
	           		$type		= "article";
	          ...
	          } elseif (($e->getDiaporama() instanceof \Cmf\ContentBundle\Entity\Diaporama)){
	           		$type		= "dossier";
	          ...
	          } elseif (($e->getTest() instanceof \Cmf\ContentBundle\Entity\Test)){
	           		$type		= "test";
	          ...
	          } elseif (($e->getPage() instanceof \Cmf\ContentBundle\Entity\Page)){
	           		$type		= "page";
              ...
              if ($e->getSubrub() instanceof \Cmf\ContentBundle\Entity\Rub) {
