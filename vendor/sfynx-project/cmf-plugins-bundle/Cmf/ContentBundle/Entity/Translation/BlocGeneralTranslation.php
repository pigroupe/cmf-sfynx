 ...
 *         uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx_sfynx_trans_cmfplugin_block_gnl", columns={
...
{
    /**
     * @ORM\ManyToOne(targetEntity="Cmf\ContentBundle\Entity\BlocGeneral", inversedBy="translations")
