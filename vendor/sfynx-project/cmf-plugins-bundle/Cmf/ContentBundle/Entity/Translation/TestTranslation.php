 ...
 * @ORM\Table(
 *         name="cont_test_translations",
 *         uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx_sfynx_trans_cmfplugin_test", columns={
 ...
 * @since      2015-02-16
 */
class TestTranslation extends AbstractTranslationEntity
{
    /**
     * @ORM\ManyToOne(targetEntity="Cmf\ContentBundle\Entity\Test", inversedBy="translations")
