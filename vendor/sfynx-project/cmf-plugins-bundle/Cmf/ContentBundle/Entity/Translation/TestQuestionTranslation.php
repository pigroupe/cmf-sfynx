 ...
 *         uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx_sfynx_trans_cmfplugin_testquestion", columns={
...
{
    /**
     * @ORM\ManyToOne(targetEntity="Cmf\ContentBundle\Entity\TestQuestion", inversedBy="translations")
