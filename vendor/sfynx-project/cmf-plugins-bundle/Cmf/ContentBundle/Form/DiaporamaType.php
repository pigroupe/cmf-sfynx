...
class DiaporamaType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder             
             ->add('enabled', 'hidden')
             ->add('blocgeneral', new \Cmf\ContentBundle\Form\BlocGeneralType($this->_em, $this->_container, "plugins_contentbundle_diaporamatype_blocgeneral_media")) 
             ->add('medias', 'collection', array(
                 'type' => new \Cmf\ContentBundle\Form\MediasDiaporamaType($this->_em, $this->_container),
                 'allow_add' => true,
                 'allow_delete' => true,
                 'by_reference' => false,
            ))
