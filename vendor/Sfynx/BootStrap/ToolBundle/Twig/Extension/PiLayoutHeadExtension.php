...
use BootStrap\ToolBundle\Twig\TokenParser\StyleSheetsTokenParser;
use BootStrap\ToolBundle\Twig\TokenParser\StyleSheetTokenParser;
use BootStrap\ToolBundle\Twig\TokenParser\JavascriptsTokenParser;
use BootStrap\ToolBundle\Twig\TokenParser\JavascriptTokenParser;
...
class PiLayoutHeadExtension extends \Twig_Extension
{
    ...
    {    
        ...
        \BootStrap\ToolBundle\Util\PiFileManager::mkdirr($this->container->getParameter("kernel.root_dir"). '/../web/yui/css', 0777);
        \BootStrap\ToolBundle\Util\PiFileManager::mkdirr($this->container->getParameter("kernel.root_dir"). '/../web/yui/js', 0777);        
        // create the input
