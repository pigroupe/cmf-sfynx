...
use BootStrap\ToolBundle\Builder\PiLogManagerInterface;
...
class PiLogManager implements PiLogManagerInterface
{
    ...
    *
    * @param    string    $path
    * @return    \BootStrap\ToolBundle\Util\PiLogManager
    * @access    public
    * @author    Etienne de Longeaux <etienne.delongeaux@gmail.com>
    */   
   ...
   {
        if (\BootStrap\ToolBundle\Util\PiFileManager::mkdirr(dirname($filePath), $mode)) {
            $this->_file = $filePath;
        }
   ...
   {
        if (\BootStrap\ToolBundle\Util\PiFileManager::mkdirr(dirname($this->_file), $mode)) {
