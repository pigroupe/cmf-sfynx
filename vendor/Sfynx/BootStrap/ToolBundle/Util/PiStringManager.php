...
use BootStrap\ToolBundle\Builder\PiStringManagerBuilderInterface;
...
class PiStringManager implements PiStringManagerBuilderInterface
{
    ...
    /**
     * This function find content file in utf8.
     *
     * @param string $path
     * @access public
     * @return string
     ...
     * @author Etienne de Longeaux <etienne.delongeaux@gmail.com>
     */    
    public static function stopWord($locale)
    {
...
//         $all_files = \BootStrap\ToolBundle\Util\PiFileManager::ListFiles($path, "json");
...
//         exit;
        ...
        $all_files = \BootStrap\ToolBundle\Util\PiFileManager::getFilesByType($path, "json");
