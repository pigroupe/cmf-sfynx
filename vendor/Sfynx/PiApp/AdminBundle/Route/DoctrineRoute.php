 ...
 */
namespace PiApp\AdminBundle\Route;

use PiApp\AdminBundle\Builder\DoctrineRouteInterface;
...
class DoctrineRoute implements DoctrineRouteInterface
{
    ...
    public function parseRoutePages()
    {
    	...
    	//
    	$all_pages     = $this->em->getRepository('PiAppAdminBundle:Page')->getAllPageHtml()->getQuery()->getResult();
    	foreach ($all_pages as $key => $page) {
        	if ( ($page instanceof \PiApp\AdminBundle\Entity\Page) && $page->getEnabled() ) {
