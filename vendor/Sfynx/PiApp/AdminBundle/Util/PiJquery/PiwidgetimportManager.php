...
class PiwidgetimportManager extends PiJqueryExtension
{
     ...
     * @static
     */
    static $menus = array('default', 'widgetimport');
    
    /**
     * @var array
     * @static
    */
    static $actions = array('default','widgetimport');
    ...
    protected function init($options = null)
    {
        ...
        if ( empty($options) || ($options == 'widgetimport') ) {
            $this->container->get('pi_app_admin.twig.extension.layouthead')->addCssFile("bundles/piappadmin/js/iGoogle/css/widgetimport/inettuts.js.css");
            $this->container->get('pi_app_admin.twig.extension.layouthead')->addCssFile("bundles/piappadmin/js/iGoogle/css/widgetimport/inettuts.css");
        } elseif ($options == 'default') {
            $this->container->get('pi_app_admin.twig.extension.layouthead')->addCssFile("bundles/piappadmin/js/iGoogle/css/default/inettuts.js.css");
            $this->container->get('pi_app_admin.twig.extension.layouthead')->addCssFile("bundles/piappadmin/js/iGoogle/css/default/inettuts.css");
        }
    }    
    ...
    public function defaultMenu($options = null)
    {
    	...
    	$response     = $this->container->get('templating')->renderResponse("PiAppTemplateBundle:Template\\Widgetimport:$template", $options);
