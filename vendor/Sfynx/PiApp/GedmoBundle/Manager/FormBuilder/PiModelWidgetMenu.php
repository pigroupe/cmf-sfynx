...
class PiModelWidgetMenu extends PiFormBuilderManager
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $ListsAvailableEntities = \PiApp\AdminBundle\Util\PiWidget\PiGedmoManager::getAvailableNavigation();
        ...
        $listFiles = $this->container->get('pi_app_admin.file_manager')->ListFilesBundle("/Resources/views/Template/Tree");
