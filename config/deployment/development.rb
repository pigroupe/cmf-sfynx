...
# SCM OPTIONS
# ==========================
set :scm_user               , "ssh_dev_cosmos" # optional
set :scm_password           , "Goynjeinyes0" # optional

# Destination
# ==========================
set :domain                 , "dev.bne.fr"
...
namespace :prepare do
  ...
  task :configuration do
    ...
    run "chmod -R 750 #{latest_release}/{www_dir}bin/*"
    run "cd #{latest_release}/www && make prepare-persistence"
    run "rm -rf #{latest_release}/{upload_path}"
    run "mkdir -p #{shared_path}/{upload_path}"
